...
class ExchangeRatesServicer(gen.exchange_rates_pb2_grpc.ExchangeRateServicer):
    ...
    def GetRates(self, request, context):
        ...
        real_names = [gen.exchange_rates_pb2.Currencies.CurrencyName.Name(name) for name in request.names]
...
def serve():
    ...
    gen.exchange_rates_pb2_grpc.add_ExchangeRateServicer_to_server(
